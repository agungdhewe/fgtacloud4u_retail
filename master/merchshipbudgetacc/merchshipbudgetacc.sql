...
ALTER TABLE `mst_merchshipbudgetacc` ADD COLUMN IF NOT EXISTS  `coa_id` varchar(20)   AFTER `merchshipbudgetacc_group`;
...
ALTER TABLE `mst_merchshipbudgetacc` MODIFY COLUMN IF EXISTS  `coa_id` varchar(20)    AFTER `merchshipbudgetacc_group`;
