	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$sqlFieldList = [
					'merchship_id' => 'A.`merchship_id`', 'unit_id' => 'A.`unit_id`', 'merchorderout_id' => 'A.`merchorderout_id`', 'fowarder_partner_id' => 'A.`fowarder_partner_id`',
					...
					'merchship_value' => 'A.`merchship_value`', 'curr_id' => 'A.`curr_id`', 'dept_id' => 'A.`dept_id`', 'principal_partner_id' => 'A.`principal_partner_id`',
					'merchsea_id' => 'A.`merchsea_id`', 'merchship_version' => 'A.`merchship_version`', 'merchship_iscommit' => 'A.`merchship_iscommit`', 'merchship_commitby' => 'A.`merchship_commitby`',
					'merchship_commitdate' => 'A.`merchship_commitdate`', 'merchship_isverify' => 'A.`merchship_isverify`', 'merchship_verifyby' => 'A.`merchship_verifyby`', 'merchship_verifydate' => 'A.`merchship_verifydate`',
