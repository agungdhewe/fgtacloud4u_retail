...
import * as hnd from  './merchship-billinform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editbillinform-caption')
...
const obj = {
	txt_merchbillin_id: $('#pnl_editbillinform-txt_merchbillin_id'),
	dt_merchbillin_date: $('#pnl_editbillinform-dt_merchbillin_date'),
	txt_merchbillin_descr: $('#pnl_editbillinform-txt_merchbillin_descr'),
	txt_merchship_id: $('#pnl_editbillinform-txt_merchship_id')
}
