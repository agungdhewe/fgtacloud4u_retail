...
import * as hnd from  './merchship-billingrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editbillingrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editbillingrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {
