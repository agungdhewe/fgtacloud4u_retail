...
ALTER TABLE `trn_merchship` ADD COLUMN IF NOT EXISTS  `merchorderout_id` varchar(30)   AFTER `unit_id`;
ALTER TABLE `trn_merchship` ADD COLUMN IF NOT EXISTS  `fowarder_partner_id` varchar(14)   AFTER `merchorderout_id`;
...
ALTER TABLE `trn_merchship` ADD COLUMN IF NOT EXISTS  `dept_id` varchar(30) NOT NULL  AFTER `curr_id`;
ALTER TABLE `trn_merchship` ADD COLUMN IF NOT EXISTS  `principal_partner_id` varchar(14)   AFTER `dept_id`;
ALTER TABLE `trn_merchship` ADD COLUMN IF NOT EXISTS  `merchsea_id` varchar(10)   AFTER `principal_partner_id`;
ALTER TABLE `trn_merchship` ADD COLUMN IF NOT EXISTS  `merchship_version` int(4) NOT NULL DEFAULT 0 AFTER `merchsea_id`;
...
ALTER TABLE `trn_merchship` ADD COLUMN IF NOT EXISTS  `merchship_iscost` tinyint(1) NOT NULL DEFAULT 0 AFTER `merchship_verifydate`;
...
ALTER TABLE `trn_merchship` MODIFY COLUMN IF EXISTS  `merchorderout_id` varchar(30)    AFTER `unit_id`;
ALTER TABLE `trn_merchship` MODIFY COLUMN IF EXISTS  `fowarder_partner_id` varchar(14)    AFTER `merchorderout_id`;
...
ALTER TABLE `trn_merchship` MODIFY COLUMN IF EXISTS  `dept_id` varchar(30) NOT NULL   AFTER `curr_id`;
ALTER TABLE `trn_merchship` MODIFY COLUMN IF EXISTS  `principal_partner_id` varchar(14)    AFTER `dept_id`;
ALTER TABLE `trn_merchship` MODIFY COLUMN IF EXISTS  `merchsea_id` varchar(10)    AFTER `principal_partner_id`;
ALTER TABLE `trn_merchship` MODIFY COLUMN IF EXISTS  `merchship_version` int(4) NOT NULL DEFAULT 0  AFTER `merchsea_id`;
...
ALTER TABLE `trn_merchship` MODIFY COLUMN IF EXISTS  `merchship_iscost` tinyint(1) NOT NULL DEFAULT 0  AFTER `merchship_verifydate`;
...
ALTER TABLE `trn_merchship` ADD KEY IF NOT EXISTS `merchorderout_id` (`merchorderout_id`);
...
ALTER TABLE `trn_merchship` ADD KEY IF NOT EXISTS `merchsea_id` (`merchsea_id`);
...
ALTER TABLE `trn_merchship` ADD CONSTRAINT `fk_trn_merchship_trn_merchorderout` FOREIGN KEY IF NOT EXISTS  (`merchorderout_id`) REFERENCES `trn_merchorderout` (`merchorderout_id`);
ALTER TABLE `trn_merchship` ADD CONSTRAINT `fk_trn_merchship_mst_partner` FOREIGN KEY IF NOT EXISTS  (`fowarder_partner_id`) REFERENCES `mst_partner` (`partner_id`);
...
ALTER TABLE `trn_merchship` ADD CONSTRAINT `fk_trn_merchship_mst_partner_2` FOREIGN KEY IF NOT EXISTS  (`principal_partner_id`) REFERENCES `mst_partner` (`partner_id`);
ALTER TABLE `trn_merchship` ADD CONSTRAINT `fk_trn_merchship_mst_merchsea` FOREIGN KEY IF NOT EXISTS  (`merchsea_id`) REFERENCES `mst_merchsea` (`merchsea_id`);
