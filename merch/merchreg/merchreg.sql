...
ALTER TABLE `trn_merchreg` ADD COLUMN IF NOT EXISTS  `partner_id` varchar(14)   AFTER `curr_id`;
...
ALTER TABLE `trn_merchreg` MODIFY COLUMN IF EXISTS  `partner_id` varchar(14)    AFTER `curr_id`;
...
CREATE TABLE IF NOT EXISTS `trn_merchregitem` (
	`merchregitem_id` varchar(14) NOT NULL , 
...
ALTER TABLE `trn_merchregitem` ADD COLUMN IF NOT EXISTS  `merchitemctg_id` varchar(30) NOT NULL  AFTER `merchitem_fob`;
...
ALTER TABLE `trn_merchregitem` MODIFY COLUMN IF EXISTS  `merchitemctg_id` varchar(30) NOT NULL   AFTER `merchitem_fob`;
