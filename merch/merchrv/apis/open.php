...
$API = new class extends merchrvBase {
	...
	public function execute($options) {
		...
		try {
			...
			$sqlFieldList = [
				'merchrv_id' => 'A.`merchrv_id`', 'unit_id' => 'A.`unit_id`', 'merchship_id' => 'A.`merchship_id`', 'merchrv_ref' => 'A.`merchrv_ref`',
				'merchrv_date' => 'A.`merchrv_date`', 'merchrv_descr' => 'A.`merchrv_descr`', 'periodemo_id' => 'A.`periodemo_id`', 'merchrv_version' => 'A.`merchrv_version`',
