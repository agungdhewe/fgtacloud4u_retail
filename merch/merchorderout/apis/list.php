	...
	public function execute($options) {
		...
		try {
			...
			$sqlFieldList = [
				...
				'curr_id' => 'A.`curr_id`', 'curr_rate' => 'A.`curr_rate`', 'merchorderout_value' => 'A.`merchorderout_value`', 'merchorderout_version' => 'A.`merchorderout_version`',
				'merchorderout_iscommit' => 'A.`merchorderout_iscommit`', 'merchorderout_commitby' => 'A.`merchorderout_commitby`', 'merchorderout_commitdate' => 'A.`merchorderout_commitdate`', '_createby' => 'A.`_createby`',
