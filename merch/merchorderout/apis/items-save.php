		...
		try {
			...
			try {
				...
				$sqlFieldList = [
					...
					'orderoutitem_qty' => 'A.`orderoutitem_qty`', 'orderoutitem_rate' => 'A.`orderoutitem_rate`', 'orderoutitem_value' => 'A.`orderoutitem_value`', 'curr_id' => 'A.`curr_id`',
					'curr_rate' => 'A.`curr_rate`', 'orderoutitem_idr' => 'A.`orderoutitem_idr`', 'merchorderout_id' => 'A.`merchorderout_id`', '_createby' => 'A.`_createby`',
