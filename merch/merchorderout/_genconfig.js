	...
	persistent: {
		'trn_merchorderout': {
			...
			data: {
				...
				merchorderout_descr: {text:'Descr', type: dbtype.varchar(255), null:true},				
				...
				merchorderout_value: { text: 'Total Value', type: dbtype.decimal(14,2), null:false, default:0, options:{disabled:true}},
