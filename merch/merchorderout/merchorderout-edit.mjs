...
const obj = {
	...
	txt_merchorderout_value: $('#pnl_edit-txt_merchorderout_value'),
...
function btn_print_click() {
	...
	var id = obj.txt_merchorderout_id.textbox('getValue');
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/merchorderout.xprint?id=' + id;
