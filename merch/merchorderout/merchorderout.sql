...
CREATE TABLE IF NOT EXISTS `trn_merchorderout` (
	...
	`merchorderout_descr` varchar(255)  , 
	...
	`merchorderout_value` decimal(14, 2) NOT NULL DEFAULT 0, 
...
ALTER TABLE `trn_merchorderout` ADD COLUMN IF NOT EXISTS  `merchorderout_descr` varchar(255)   AFTER `merchorderout_date`;
...
ALTER TABLE `trn_merchorderout` ADD COLUMN IF NOT EXISTS  `merchorderout_value` decimal(14, 2) NOT NULL DEFAULT 0 AFTER `curr_rate`;
ALTER TABLE `trn_merchorderout` ADD COLUMN IF NOT EXISTS  `merchorderout_version` int(4) NOT NULL DEFAULT 0 AFTER `merchorderout_value`;
...
ALTER TABLE `trn_merchorderout` MODIFY COLUMN IF EXISTS  `merchorderout_descr` varchar(255)    AFTER `merchorderout_date`;
...
ALTER TABLE `trn_merchorderout` MODIFY COLUMN IF EXISTS  `merchorderout_value` decimal(14, 2) NOT NULL DEFAULT 0  AFTER `curr_rate`;
ALTER TABLE `trn_merchorderout` MODIFY COLUMN IF EXISTS  `merchorderout_version` int(4) NOT NULL DEFAULT 0  AFTER `merchorderout_value`;
...
ALTER TABLE `trn_merchorderoutitem` ADD COLUMN IF NOT EXISTS  `orderoutitem_qty` int(4) NOT NULL DEFAULT 0 AFTER `orderoutitem_descr`;
ALTER TABLE `trn_merchorderoutitem` ADD COLUMN IF NOT EXISTS  `orderoutitem_rate` decimal(12, 2) NOT NULL DEFAULT 0 AFTER `orderoutitem_qty`;
ALTER TABLE `trn_merchorderoutitem` ADD COLUMN IF NOT EXISTS  `orderoutitem_value` decimal(14, 2) NOT NULL DEFAULT 0 AFTER `orderoutitem_rate`;
ALTER TABLE `trn_merchorderoutitem` ADD COLUMN IF NOT EXISTS  `curr_id` varchar(10) NOT NULL  AFTER `orderoutitem_value`;
ALTER TABLE `trn_merchorderoutitem` ADD COLUMN IF NOT EXISTS  `curr_rate` decimal(12, 0) NOT NULL DEFAULT 0 AFTER `curr_id`;
ALTER TABLE `trn_merchorderoutitem` ADD COLUMN IF NOT EXISTS  `orderoutitem_idr` decimal(14, 2) NOT NULL DEFAULT 0 AFTER `curr_rate`;
ALTER TABLE `trn_merchorderoutitem` ADD COLUMN IF NOT EXISTS  `merchorderout_id` varchar(30) NOT NULL  AFTER `orderoutitem_idr`;
...
ALTER TABLE `trn_merchorderoutitem` MODIFY COLUMN IF EXISTS  `orderoutitem_qty` int(4) NOT NULL DEFAULT 0  AFTER `orderoutitem_descr`;
ALTER TABLE `trn_merchorderoutitem` MODIFY COLUMN IF EXISTS  `orderoutitem_rate` decimal(12, 2) NOT NULL DEFAULT 0  AFTER `orderoutitem_qty`;
ALTER TABLE `trn_merchorderoutitem` MODIFY COLUMN IF EXISTS  `orderoutitem_value` decimal(14, 2) NOT NULL DEFAULT 0  AFTER `orderoutitem_rate`;
ALTER TABLE `trn_merchorderoutitem` MODIFY COLUMN IF EXISTS  `curr_id` varchar(10) NOT NULL   AFTER `orderoutitem_value`;
ALTER TABLE `trn_merchorderoutitem` MODIFY COLUMN IF EXISTS  `curr_rate` decimal(12, 0) NOT NULL DEFAULT 0  AFTER `curr_id`;
ALTER TABLE `trn_merchorderoutitem` MODIFY COLUMN IF EXISTS  `orderoutitem_idr` decimal(14, 2) NOT NULL DEFAULT 0  AFTER `curr_rate`;
ALTER TABLE `trn_merchorderoutitem` MODIFY COLUMN IF EXISTS  `merchorderout_id` varchar(30) NOT NULL   AFTER `orderoutitem_idr`;
