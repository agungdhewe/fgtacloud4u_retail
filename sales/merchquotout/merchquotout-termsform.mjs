...
const obj = {
	txt_merchquotoutterm_id: $('#pnl_edittermsform-txt_merchquotoutterm_id'),
	txt_merchquotoutterm_descr: $('#pnl_edittermsform-txt_merchquotoutterm_descr'),
	txt_merchquotoutterm_days: $('#pnl_edittermsform-txt_merchquotoutterm_days'),
	chk_merchquotoutterm_isdp: $('#pnl_edittermsform-chk_merchquotoutterm_isdp'),
	txt_merchquotoutterm_paymentpercent: $('#pnl_edittermsform-txt_merchquotoutterm_paymentpercent'),
	txt_merchquotout_id: $('#pnl_edittermsform-txt_merchquotout_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchquotoutterm_id,
		autoid: true,
		logview: 'trn_merchquotoutterm',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.merchquotoutterm_days = 0
		data.merchquotoutterm_paymentpercent = 0
...
function form_idsetup(options) {
	var objid = obj.txt_merchquotoutterm_id
