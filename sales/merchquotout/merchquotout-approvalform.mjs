...
const obj = {
	txt_merchquotoutappr_id: $('#pnl_editapprovalform-txt_merchquotoutappr_id'),
	chk_merchquotoutappr_isapproved: $('#pnl_editapprovalform-chk_merchquotoutappr_isapproved'),
	txt_merchquotoutappr_by: $('#pnl_editapprovalform-txt_merchquotoutappr_by'),
	txt_merchquotoutappr_date: $('#pnl_editapprovalform-txt_merchquotoutappr_date'),
	txt_merchquotout_version: $('#pnl_editapprovalform-txt_merchquotout_version'),
	chk_merchquotoutappr_isdeclined: $('#pnl_editapprovalform-chk_merchquotoutappr_isdeclined'),
	txt_merchquotoutappr_declinedby: $('#pnl_editapprovalform-txt_merchquotoutappr_declinedby'),
	txt_merchquotoutappr_declineddate: $('#pnl_editapprovalform-txt_merchquotoutappr_declineddate'),
	txt_merchquotoutappr_notes: $('#pnl_editapprovalform-txt_merchquotoutappr_notes'),
	txt_merchquotout_id: $('#pnl_editapprovalform-txt_merchquotout_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchquotoutappr_id,
		autoid: true,
		logview: 'trn_merchquotoutappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.merchquotout_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_merchquotoutappr_id
