...
/**
 * retail/sales/merchquotout/apis/terms-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends merchquotoutBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->merchquotoutterm_descr=='') { $obj->merchquotoutterm_descr = '--NULL--'; }
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'merchquotoutterm_id', 'merchquotoutterm_descr', 'merchquotoutterm_days', 'merchquotoutterm_isdp', 'merchquotoutterm_paymentpercent', 'merchquotout_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
