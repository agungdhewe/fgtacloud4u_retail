...
const obj = {
	...
	txt_merchorderinitem_price: $('#pnl_edititemsform-txt_merchorderinitem_price'),
	txt_merchorderinitem_pricediscpercent: $('#pnl_edititemsform-txt_merchorderinitem_pricediscpercent'),
	chk_merchorderinitem_isdiscvalue: $('#pnl_edititemsform-chk_merchorderinitem_isdiscvalue'),
	txt_merchorderinitem_pricediscvalue: $('#pnl_edititemsform-txt_merchorderinitem_pricediscvalue'),
	txt_merchorderinitem_subtotal: $('#pnl_edititemsform-txt_merchorderinitem_subtotal'),
	txt_merchorderinitem_estgp: $('#pnl_edititemsform-txt_merchorderinitem_estgp'),
	txt_merchorderinitem_estgppercent: $('#pnl_edititemsform-txt_merchorderinitem_estgppercent'),
...
export async function init(opt) {
	...
	obj.txt_merchorderinitem_qty.numberbox({onChange: (newvalue, oldvalue) => {
		if (typeof hnd!=='undefined') {
			if (typeof hnd.merchorderinitem_qty_changed==='function') {hnd.merchorderinitem_qty_changed(newvalue, oldvalue)} 
		}
	}});
	
	obj.txt_merchorderinitem_price.numberbox({onChange: (newvalue, oldvalue) => {
		if (typeof hnd!=='undefined') {
			if (typeof hnd.merchorderinitem_price_changed==='function') {hnd.merchorderinitem_price_changed(newvalue, oldvalue)} 
		}
	}});
	
	obj.txt_merchorderinitem_pricediscpercent.numberbox({onChange: (newvalue, oldvalue) => {
		if (typeof hnd!=='undefined') {
			if (typeof hnd.merchorderinitem_pricediscpercent_changed==='function') {hnd.merchorderinitem_pricediscpercent_changed(newvalue, oldvalue)} 
		}
	}});
	
	obj.chk_merchorderinitem_isdiscvalue.checkbox({onChange: (newvalue, oldvalue) => {
		if (typeof hnd!=='undefined') {
			if (typeof hnd.merchorderinitem_isdiscvalue_changed==='function') {hnd.merchorderinitem_isdiscvalue_changed(newvalue, oldvalue)} 
		}
	}});
	
	obj.txt_merchorderinitem_pricediscvalue.numberbox({onChange: (newvalue, oldvalue) => {
		if (typeof hnd!=='undefined') {
			if (typeof hnd.merchorderinitem_pricediscvalue_changed==='function') {hnd.merchorderinitem_pricediscvalue_changed(newvalue, oldvalue)} 
		}
	}});
		...
		OnDataLoading: (criteria, options) => {
			...
			if (typeof hnd!=='undefined') { 
				if (typeof hnd.cbo_merchitem_id_dataloading === 'function') {
					hnd.cbo_merchitem_id_dataloading(criteria, options);
				}
			}
		},
		...
		OnDataLoading: (criteria, options) => {
			...
			if (typeof hnd!=='undefined') { 
				if (typeof hnd.cbo_accbudget_id_dataloading === 'function') {
					hnd.cbo_accbudget_id_dataloading(criteria, options);
				}
			}
		},
		OnDataLoaded : (result, options) => {
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.merchorderin_descr)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.merchorderinitem_price = 0
		data.merchorderinitem_pricediscpercent = 0
		data.merchorderinitem_pricediscvalue = 0
		data.merchorderinitem_subtotal = 0
		data.merchorderinitem_estgp = 0
		data.merchorderinitem_estgppercent = 0
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['merchitemctg_id', 'merchsea_id', 'brand_id', 'itemclass_id', 'accbudget_id', 'coa_id', ];
