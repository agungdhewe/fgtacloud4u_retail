...
const obj = {
	txt_webproptype_id: $('#pnl_edit-txt_webproptype_id'),
	txt_webproptype_name: $('#pnl_edit-txt_webproptype_name'),
	txt_webproptype_group: $('#pnl_edit-txt_webproptype_group')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_webproptype_id,
		autoid: false,
		logview: 'web_webproptype',
...
function form_idsetup(options) {
	var objid = obj.txt_webproptype_id
