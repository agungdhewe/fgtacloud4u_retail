...
/**
 * retail/webcommerce/webeditorial/apis/picture-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel picture webeditorial (web_editorial)
 *
...
$API = new class extends webeditorialBase {
	...
	public function execute($data, $options, $files) {
		$tablename = 'web_editorialpic';
		$primarykey = 'editorialpic_id';
		...
		try {
			...
			// if ($obj->editorialpic_descr=='--NULL--') { unset($obj->editorialpic_descr); }
			...
			try {
				...
				$header_table = 'web_editorial';
				$header_primarykey = 'editorial_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'editorialpic_id', 'editorialpic_name', 'editorialpic_descr', 'editorialpic_order', 'editorialpic_file', 'editorial_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
