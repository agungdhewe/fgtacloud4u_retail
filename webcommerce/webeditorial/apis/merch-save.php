...
/**
 * retail/webcommerce/webeditorial/apis/merch-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel merch webeditorial (web_editorial)
 *
...
$API = new class extends webeditorialBase {
	...
	public function execute($data, $options, $files) {
		$tablename = 'web_editorialmerch';
		$primarykey = 'editorialmerch_id';
		...
		try {
			...
			$obj->merch_id = strtoupper($obj->merch_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'editorialmerch_id', 'merch_id', 'brand_id', 'editorial_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
