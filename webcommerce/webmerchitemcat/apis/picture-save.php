...
/**
 * retail/webcommerce/webmerchitemcat/apis/picture-save.php
 *
 * ==========
 * Detil-Save
 * ==========
	...
	public function execute($data, $options, $files) {
		...
		try {
			...
			try {
				...
				$fieldname = 'merchitemcatpic_file';	
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'merchitemcatpic_id', 'merchitemcatpic_name', 'merchitemcatpic_descr', 'merchitemcatpic_order', 'merchitemcatpic_file', 'merchitemcat_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
