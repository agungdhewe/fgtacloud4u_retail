...
/**
 * retail/webcommerce/webmerchitemcat/apis/prop-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel prop webmerchitemcat (web_merchitemcat)
 *
...
$API = new class extends webmerchitemcatBase {
	...
	public function execute($data, $options, $files) {
		$tablename = 'web_merchitemcatprop';
		$primarykey = 'merchitemcatprop_id';
		...
		try {
			...
			try {
				...
				$header_table = 'web_merchitemcat';
				$header_primarykey = 'merchitemcat_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'merchitemcatprop_id', 'webproptype_id', 'merchitemcatprop_value', 'merchitemcat_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
