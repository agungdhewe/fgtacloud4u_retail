...
/**
 * retail/webcommerce/webmerchitemcat/apis/picture-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel picture webmerchitemcat (web_merchitemcat)
...
$API = new class extends webmerchitemcatBase {
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("select count(*) as n from web_merchitemcatpic A" . $where->sql);
