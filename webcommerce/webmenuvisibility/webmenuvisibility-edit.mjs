...
const obj = {
	txt_menuvisibility_id: $('#pnl_edit-txt_menuvisibility_id'),
	txt_menuvisibility_name: $('#pnl_edit-txt_menuvisibility_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_menuvisibility_id,
		autoid: true,
		logview: 'web_menuvisibility',
...
function form_idsetup(options) {
	var objid = obj.txt_menuvisibility_id
