...
const obj = {
	txt_editorialtype_id: $('#pnl_edit-txt_editorialtype_id'),
	txt_editorialtype_name: $('#pnl_edit-txt_editorialtype_name'),
	txt_editorialtype_order: $('#pnl_edit-txt_editorialtype_order')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_editorialtype_id,
		autoid: false,
		logview: 'web_editorialtype',
...
function form_idsetup(options) {
	var objid = obj.txt_editorialtype_id
