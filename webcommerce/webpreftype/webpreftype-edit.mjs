...
const obj = {
	txt_preftype_id: $('#pnl_edit-txt_preftype_id'),
	txt_preftype_name: $('#pnl_edit-txt_preftype_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_preftype_id,
		autoid: false,
		logview: 'web_preftype',
