...
const obj = {
	txt_merchformat_id: $('#pnl_edit-txt_merchformat_id'),
	txt_merchformat_name: $('#pnl_edit-txt_merchformat_name'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchformat_id,
		autoid: false,
		logview: 'web_merchformat',
...
function form_idsetup(options) {
	var objid = obj.txt_merchformat_id
