...
/**
 * retail/webcommerce/webmerch/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header webmerch (web_merch)
 *
 ...
 * tanggal 31/03/2021
 */
$API = new class extends webmerchBase {
	...
	public function execute($data, $options, $files) {
		...
		try {
			...
			$obj->merch_name = strtoupper($obj->merch_name);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'merch_id', 'merch_name', 'merch_file', 'cluster_id', 'brand_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
