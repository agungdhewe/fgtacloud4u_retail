...
/**
 * retail/webcommerce/webmerch/apis/xapi.base.php
 *
 * webmerchBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul webmerch
 *
 ...
 * tanggal 31/03/2021
 */
class webmerchBase extends WebAPI {

	protected $main_tablename = "web_merch";
	protected $main_primarykey = "merch_id";
	protected $main_field_version = "merch_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*webmerch*/.txt";
		// debug::disable();
