...
/**
 * retail/webcommerce/website/apis/xapi.base.php
 *
 * websiteBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul website
 *
 ...
 * tanggal 31/03/2021
 */
class websiteBase extends WebAPI {

	protected $main_tablename = "web_site";
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*website*/.txt";
		// debug::disable();
