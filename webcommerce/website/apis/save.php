...
/**
 * retail/webcommerce/website/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header website (web_site)
 *
...
$API = new class extends websiteBase {
	...
	public function execute($data, $options, $files) {
		...
		try {
			...
			$obj->site_contact = strtoupper($obj->site_contact);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'site_id', 'site_name', 'site_address1', 'site_address2', 'site_address3', 'site_phone', 'site_contact', 'site_isdisabled', 'site_geoloc', 'site_order', 'site_mainpic', 'city_id', 'cluster_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($record, [
				...
				'city_name' => \FGTA4\utils\SqlUtility::Lookup($record['city_id'], $this->db, 'web_city', 'city_id', 'city_name'),
