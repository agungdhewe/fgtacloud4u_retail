...
/**
 * retail/webcommerce/website/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel detil website (web_site)
 *
	...
	public function execute($data, $options, $files) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'sitepic_id', 'sitepic_descr', 'sitepic_order', 'sitepic_file', 'site_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
