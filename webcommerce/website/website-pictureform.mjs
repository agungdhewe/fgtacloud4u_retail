...
const fl_sitepic_file_img = $('#pnl_editpictureform-fl_sitepic_file_img');
const fl_sitepic_file_lnk = $('#pnl_editpictureform-fl_sitepic_file_link');				
			

const pnl_form = $('#pnl_editpictureform-form')
const obj = {
	txt_sitepic_id: $('#pnl_editpictureform-txt_sitepic_id'),
	txt_sitepic_descr: $('#pnl_editpictureform-txt_sitepic_descr'),
	txt_sitepic_order: $('#pnl_editpictureform-txt_sitepic_order'),
	fl_sitepic_file: $('#pnl_editpictureform-fl_sitepic_file'),
	txt_site_id: $('#pnl_editpictureform-txt_site_id')
}
