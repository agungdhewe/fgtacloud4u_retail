...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'web_clusterbrand';
		$primarykey = 'clusterbrand_id';
		...
		try {
			...
			$obj->clusterbrand_id = strtoupper($obj->clusterbrand_id);
			...
			try {
				...
				$header_table = 'web_cluster';
				$header_primarykey = 'cluster_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'clusterbrand_id', 'brand_id', 'cluster_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'brand_name' => \FGTA4\utils\SqlUtility::Lookup($data->brand_id, $this->db, 'web_brand', 'brand_id', 'brand_name'),
