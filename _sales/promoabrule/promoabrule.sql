...
ALTER TABLE `mst_promoabrule` ADD COLUMN IF NOT EXISTS  `promoabrule_code` varchar(3)   AFTER `promoabrule_id`;
...
ALTER TABLE `mst_promoabrule` MODIFY COLUMN IF EXISTS  `promoabrule_code` varchar(3)   AFTER `promoabrule_id`;
