...
ALTER TABLE `mst_promoabmodel` ADD COLUMN IF NOT EXISTS  `promoabrule_ishasgroupa` tinyint(1) NOT NULL DEFAULT 0 AFTER `promoabrule_code`;
...
ALTER TABLE `mst_promoabmodel` MODIFY COLUMN IF EXISTS  `promoabrule_ishasgroupa` tinyint(1) NOT NULL DEFAULT 0 AFTER `promoabrule_code`;
