...
const obj = {
	txt_merchorderinappr_id: $('#pnl_editapprovalform-txt_merchorderinappr_id'),
	chk_merchorderinappr_isapproved: $('#pnl_editapprovalform-chk_merchorderinappr_isapproved'),
	txt_merchorderinappr_by: $('#pnl_editapprovalform-txt_merchorderinappr_by'),
	txt_merchorderinappr_date: $('#pnl_editapprovalform-txt_merchorderinappr_date'),
	txt_merchorderin_version: $('#pnl_editapprovalform-txt_merchorderin_version'),
	chk_merchorderinappr_isdeclined: $('#pnl_editapprovalform-chk_merchorderinappr_isdeclined'),
	txt_merchorderinappr_declinedby: $('#pnl_editapprovalform-txt_merchorderinappr_declinedby'),
	txt_merchorderinappr_declineddate: $('#pnl_editapprovalform-txt_merchorderinappr_declineddate'),
	txt_merchorderinappr_notes: $('#pnl_editapprovalform-txt_merchorderinappr_notes'),
	txt_merchorderin_id: $('#pnl_editapprovalform-txt_merchorderin_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchorderinappr_id,
		autoid: true,
		logview: 'trn_merchorderinappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.merchorderin_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_merchorderinappr_id
