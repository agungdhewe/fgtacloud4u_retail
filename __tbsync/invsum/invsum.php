...
if (is_file(__DIR__ .'/invsum.php-handler.php')) {
	require_once __DIR__ .'/invsum.php-handler.php';
}

/**
 * retail/tbsync/invsum/invsum.php
 *
 * ===================================================================
 * Entry point Program Module invsum
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\invsum_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new invsum_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
