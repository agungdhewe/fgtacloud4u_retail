...
if (is_file(__DIR__ .'/invitem.php-handler.php')) {
	require_once __DIR__ .'/invitem.php-handler.php';
}

/**
 * retail/tbsync/invitem/invitem.php
 *
 * ===================================================================
 * Entry point Program Module invitem
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\invitem_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new invitem_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
