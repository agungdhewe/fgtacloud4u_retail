...
import * as hnd from  './invitem-edit-hnd.mjs'
...
const obj = {
	txt_tbinvitem_id: $('#pnl_edit-txt_tbinvitem_id'),
	txt_region_id: $('#pnl_edit-txt_region_id'),
	txt_heinv_id: $('#pnl_edit-txt_heinv_id'),
	txt_heinvitem_line: $('#pnl_edit-txt_heinvitem_line'),
	txt_heinvitem_id: $('#pnl_edit-txt_heinvitem_id'),
	txt_heinvitem_size: $('#pnl_edit-txt_heinvitem_size'),
	txt_heinvitem_colnum: $('#pnl_edit-txt_heinvitem_colnum'),
	txt_heinvitem_barcode: $('#pnl_edit-txt_heinvitem_barcode')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_tbinvitem_id,
		autoid: false,
		logview: 'sync_tbinvitem',
...
function form_idsetup(options) {
	var objid = obj.txt_tbinvitem_id
