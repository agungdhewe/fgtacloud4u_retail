...
/**
 * retail/tbsync/invitem/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header invitem (sync_tbinvitem)
...
$API = new class extends invitemBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.heinv_id LIKE CONCAT('%', :search, '%') OR A.heinvitem_barcode LIKE CONCAT('%', :search, '%') "
			];
			if (is_object($hnd)) {
